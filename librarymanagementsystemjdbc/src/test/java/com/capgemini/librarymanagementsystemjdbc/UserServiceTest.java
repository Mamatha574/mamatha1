...
public class UserServiceTest {
	...
	public void testLoginValid() {
		UserBean info = service.login("mamatha@gmail.com", "mamtha@1234");
		Assertions.assertNotNull(info);
	}

	@Test
	public void testLoginInvalid() {
		UserBean info = service.login("mamatha@gmail.com", "mamatha1234");
	...
	public void testUpdatePasswordValid() {
		boolean check = service.updatePassword("mamatha@gmail.com", "mmatha@1234", "Mamatha@123", "admin");
		Assertions.assertTrue(check);
	}

	@Test
	public void testUpdatePasswordInvalid() {
		boolean check = service.updatePassword("mamatha@gmail.com", "mamatha@1234", "Mamatha@123", "student");
		Assertions.assertFalse(check);
	}
	@Test
	...
	public void testBookHistoryDetailsValid() {
		List<BookIssuseBean> info = service.bookHistoryDetails(100002);
		Assertions.assertNotNull(info);
		Assertions.assertEquals(1, info.size());		
	}
	...
	public void testBookHistoryDetailsInvalid() {
		List<BookIssuseBean> info = service.bookHistoryDetails(100003);
		Assertions.assertNotNull(info);
